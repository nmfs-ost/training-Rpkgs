...
# Will need to provide a file path with path = "your_filepath" if not working within a project at first. After you run create_package(), a Rstudio project will be created for your package.
```
